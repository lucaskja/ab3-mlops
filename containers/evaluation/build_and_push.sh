...
# Build and push YOLOv11 evaluation container to ECR for AMD64 architecture
...
REPOSITORY_NAME="yolov11-evaluation"
IMAGE_TAG="latest"

# Full image URI
IMAGE_URI="${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/${REPOSITORY_NAME}:${IMAGE_TAG}"

echo "Building and pushing evaluation container for AMD64 architecture..."
...
echo "Successfully built and pushed evaluation container for AMD64!"
echo "Image URI: ${IMAGE_URI}"
